 ...
 *
 * methods:
 *      onClickSquare(View view): Calculates the tip
 *      onQuit(View view): Adds calculateTip + bill
 *      onAgain(View view)
 *
...
public class GameActivity extends AppCompatActivity {
    ...
    /**
     *  Calls many things in the Board class to play the tic tac toe game behind scenes.
     *
     * @param View view
     * @return
     */
    ...
    /**
     * Creates another intent of the activity to create a new game
     *
     * @param View view
     * @return
     */
